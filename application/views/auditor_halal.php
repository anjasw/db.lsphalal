...
<div class="a">
 <a href="<?php echo base_url() ?>auditor/export"><button type="button" class="btn btn-success pull-left">Export To Excel</button></a>
 </div>
<div class="b">
 <a href="<?php echo base_url() ?>auditor/lap_audithalal"><button type="button" class="btn btn-success pull-left">See Report</button></a>
 </div>

 <div class="c">
 <a href="<?php echo base_url() ?>auditor/input_auditor"><button type="button" class="btn btn-success pull-left">Add Data</button></a>
 </div>
         ...
         ?>
            <tr>
               ...
               <td><?php echo  $r->kom_tek_1 ?></td>
                ...
                <td>
                 <a href="<?php echo base_url().'auditor/detail/'.$r->no ?>"><button type="button" class="btn btn-success btn-sm">Detail</button></a>
                </td>
                 <td>
                <a href="<?php echo base_url().'auditor/hapus/'.$r->no ?>"
                ...
                <td>
                     <a href="<?php echo base_url().'auditor/edit/'.$r->no ?>"><button type="button" class="btn btn-warning btn-sm">Edit</button></a>

                  </td>
                  <td>
                      <a href="<?php echo base_url().'auditor/print_out/'.$r->no ?>"><button type="button" class="btn btn-primary btn-sm" name="print">Print</button></a>
                        </td>
            </tr>
       <?php $no++; } ?>
        </tbody>
