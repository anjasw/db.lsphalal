        ...
        <form method="post" action="">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10" style="margin-left: -10px; width: ">
                  <input type="text" name="nama" required="" class="form-control" placeholder="Masukan Nama" value="<?php echo set_value('nama', $data->row()->nama) ?>">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10" style="margin-left: -10px; width: ">
                  <input type="text" name="perusahaan"  class="form-control" placeholder="Masukan perusahaan" value="<?php echo set_value('perusahaan', $data->row()->perusahaan) ?>">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10" style="margin-left: -10px; width: ">
                  <input type="text" name="email" class="form-control" placeholder="Masukan email" value="<?php echo set_value('email', $data->row()->email) ?>">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10" style="margin-left: -10px; width: ">
                  <input type="text" name="metode" class="form-control" placeholder="Masukan metode" value="<?php echo set_value('metode', $data->row()->metode) ?>">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10" style="margin-left: -10px; width: ">
                  <input type="text" name="pembayaran" class="form-control" placeholder="Masukan pembayaran" value="<?php echo set_value('pembayaran', $data->row()->pembayaran) ?>">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10" style="margin-left: -10px; width: ">
                  <input type="text" name="informasi" class="form-control" placeholder="Masukan informasi" value="<?php echo set_value('informasi', $data->row()->informasi) ?>">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10" style="margin-left: -10px; width: ">
                  <input type="text" name="tindak_lanjut"  class="form-control" placeholder="Masukan tindak lanjut"value="<?php echo set_value('tindak_lanjut', $data->row()->tindak_lanjut) ?>">
                </div>
              </div>
