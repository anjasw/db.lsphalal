	...
	<div class="container">
		...
		<div id="show-product">
			...
			<form method="post" action="">
				<div class="box-body">
					<div class="">
						<a href="<?php echo base_url() ?>penyembelih"><button type="button" style="border:1px solid #222d32; background-color: #222d32; width: 150px; height: 40px;" class="btn btn-primary pull-left">See Data</button></a>
						<a href="<?php echo base_url() ?>penyembelih/asesor"><button type="button" style="border:1px solid #222d32; background-color: #222d32; width: 150px; height: 40px; margin-left: 73%;" class="btn btn-primary pull-left">Add Data Assessor</button></a>
						<br><br><br>
						<div class="panel panel-default">
							<div class="panel-body">
