 ...
 <div class="container">
      ...
      <div id="show-product">
        ...
        <form method="post" action="">
              <div class="box-body">
                <div class="">
                <a href="<?php echo base_url() ?>auditor/InputData"><button type="button" class="btn btn-primary pull-left">Add Data </button></a>

                <div class="a">

                <a href="<?php echo base_url()?>auditor"><button type="button"  class="btn btn-primary pull-left">See Data</button></a>
                      ...
                      <tbody>
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td>
                                      <a href="<?php echo base_url().'auditor/hapus2/'.$r->id_asesor ?>"
                                      onClick="return confirm('Hapus Inputan')"/><button type="button" class="btn btn-danger btn-sm">Hapus</button></a>

                                      <a href="<?php echo base_url().'auditor/update/'.$r->id_asesor ?>"><button type="button" class="btn btn-warning btn-sm">Edit</button></a>
