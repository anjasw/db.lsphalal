	...
	<div class="container">
		...
		<div id="show-product">
			...
			<form method="post" action="">
				<div class="box-body">
					<div class="">
						<a href="<?php echo base_url() ?>penyelia"><button type="button" style="border:1px solid #222d32; background-color: #222d32; width: 150px; height: 40px;" class="btn btn-primary pull-left">See Data</button></a>
						<a href="<?php echo base_url() ?>asesor"><button type="button" style="border:1px solid #222d32; background-color: #222d32; width: 150px; height: 40px; margin-left: 73%;" class="btn btn-primary pull-left">Add Data Assessor</button></a>
						<br><br><br>
						<div class="panel panel-default">
							<div class="panel-body">
								<div class="form-group">
									...
									<div class="col-sm-10" style="margin-left: px; width: ">
										<input type="number" name="batch" required="" class="form-control" id="batch" value="<?php echo set_value('batch', $data->row()->batch) ?>">
								...
								<div class="form-group">
									...
									<div class="col-sm-10" style="margin-left: ;">
										<select name="assesor" class="form-control">
											<option value="<?php echo set_value($data->row()->assesor) ?>" selected><?php echo $data->row()->assesor ?></option>
                      <?php foreach ($a->result() as $row): ?>

                          <option value="<?php echo $row->asesor ?>"><?php echo $row->asesor ?></option>
               			 ...
               			 <?php endforeach; ?>
								...
								<div class="col-sm-10" style="margin-left: ">
									<input type="text" class="form-control" name="asesi" id="asesi" value="<?php echo set_value('asesi', $data->row()->asesi) ?>">
                ...
                <?php } ?>
								...
								<div class="col-sm-2" style="margin-left: -110px; width: 350px">
									<input type="text" id="email" class="form-control" name="email" value="<?php echo set_value('email', $data->row()->email) ?>">
								...
								<div class="col-sm-1" style="margin-left: 80px; width: 235px; margin-top: -25px;">
									<input type="text" name="no_hp" class="form-control" value="<?php echo set_value('no_hp', $data->row()->no_hp) ?>">
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									...
									<input type="date" id="tanggal" class="form-control" name="tgl_asesmen" placeholder="Masukan Tanggal" value="<?php echo set_value('tgl_asesmen', $data->row()->tgl_asesmen) ?>">
                    ...
                    <?php if ('Tidak' === $data->row()->uji_lanjut) { ?>
                ...
                <?php } ?>
								...
								<div class="col-sm-1" style="margin-left: -120px; width: 280px;">
									<input type="date" name="tgl_rpt_kmt_tkns" class="form-control" value="<?php echo set_value('tgl_rpt_kmt_tkns', $data->row()->tgl_rpt_kmt_tkns) ?>">
							...
							<div class="form-group">
								...
								<div class="col-sm-2" style="width: 250px;">
									...
									<select name="kom_tek_1" class="form-control">
										<option value="<?php echo set_value($data->row()->kom_tek_1) ?>" selected><?php echo $data->row()->kom_tek_1 ?></option>
                    <?php foreach ($a->result() as $row): ?>
                   ...
                   <?php endforeach; ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-3" style="margin-left: -90px; width: 265px;">
										...
										<select name="kom_tek_3" class="form-control">
											<option value="<?php echo set_value($data->row()->kom_tek_3) ?>" selected><?php echo $data->row()->kom_tek_3 ?></option>
                      <?php foreach ($a->result() as $row): ?>
                    ...
                    <?php if ('Kompeten' === $data->row()->keputusan) { ?>
                ...
                <?php    }else{ ?>
                  ...
                  <?php } ?>
								...
								<div class="col-sm-4" style="margin-left: -50px; width: 416px; ">
									<input type="date" name="tgl_pen_ser" class="form-control" value="<?php echo set_value('tgl_pen_ser',$data->row()->tgl_pen_ser) ?>">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="keterangan" placeholder="Masukan Keterangan" value="<?php echo set_value('keterangan',$data->row()->keterangan) ?>">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<div class="col-sm-10" style="margin-left:  -15px; width: 103%  ">
										<input type="text" id="no_serti" name="no_serti" value="<?php echo set_value('no_serti', $data->row()->no_serti) ?>" class="form-control">
									</div>
								</div>
								<br>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" id="no_ser_ser" name="no_ser_ser"$hasilkode value="<?php echo set_value('no_ser_ser', $data->row()->no_ser_ser) ?>" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" id="no_reg_ser" name="no_reg_ser" value="<?php echo set_value('no_reg_ser', $data->row()->no_reg_ser); ?>" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" name="no_ber_ac" value="<?php echo set_value('no_ber_ac',$data->row()->no_ber_ac) ?>">
                  ...
                  foreach ($hasil->result() as $hasil) {
                   ?>
                      ...
                      <option value="<?php echo set_value('provinsi',$data->row()->provinsi) ?>" selected><?php echo $data->row()->provinsi ?></option>
                    <option value="Nanggro Aceh Darussalam"> Nanggro Aceh Darussalam </option>
                    	<option value="Sumatera Utara"> Sumatera Utara </option>
								...
								<div class="col-sm-4" style="margin-left: -135px; width: 380px; margin-top: -15px; ">
									<input type="number" name="thn_lap" class="form-control" value="<?php echo set_value('thn_lap', $data->row()->thn_lap) ?>">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="date" class="form-control" name="tanggal" placeholder="Masukan Tanggal" value="<?php echo set_value('tanggal', $data->row()->tanggal) ?>">
                  ...
                  <select type="text" class="form-control" >
                      ...
                      <option> No</option>
							...
							<div class="box-footer">
								<button type="submit" style="" name="simpan" class="btn btn-warning btn-lg  btn-block" style="">
                  Save</button>
