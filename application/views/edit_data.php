							...
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-10" style="margin-left: ;">
										...
										<option value="<?php echo $data->row()->assesor ?>" selected><?php echo $data->row()->assesor ?></option>
							...
							<div class="form-group">
								...
								<div class="col-sm-2" style="width: 250px;">
									...
									<select name="kom_tek_1" class="form-control">
										<option value="<?php echo $data->row()->kom_tek_1 ?>" selected><?php echo $data->row()->kom_tek_1 ?></option>
                    <?php foreach ($a->result() as $row): ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-2" style="margin-left: -80px; width: 250px;">
										...
										<select name="kom_tek_2" class="form-control">
											<option value="<?php echo $data->row()->kom_tek_2 ?>" selected><?php echo $data->row()->kom_tek_2 ?></option>
                      <?php foreach ($a->result() as $row): ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-3" style="margin-left: -90px; width: 265px;">
										...
										<select name="kom_tek_3" class="form-control">
											<option value="<?php echo $data->row()->kom_tek_3 ?>" selected><?php echo $data->row()->kom_tek_3 ?></option>
                      <?php foreach ($a->result() as $row): ?>
