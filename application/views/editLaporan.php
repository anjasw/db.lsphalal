      ...
      <div id="show-product">
        ...
        <form method="post" action="">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="no_dokumen" id="assesor" required="" placeholder="" value="<?php echo set_value('no_dokumen', $data->row()->no_dokumen) ?>">
                </div>
...
Revised Edition</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="ed_Revisi" id="edisi_revisi" required="" placeholder="" value="<?php echo set_value('ed_Revisi', $data->row()->ed_Revisi) ?>">
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="date" class="form-control" name="tgl_berlaku" id="no_met" required="" placeholder="" value="<?php echo set_value('tgl_berlaku', $data->row()->tgl_berlaku) ?>">
                </div>
              </div>
<br><br>
<br>
              ...
              <label for="halaman" class="col-sm-2 control-label"> Page </label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="halaman" id="no_met" required="" placeholder="" value="<?php echo set_value('halaman', $data->row()->halaman) ?>">
                </div>
              </div>
              <br>
              <br>
